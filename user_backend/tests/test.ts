...
const MOCK_AUTH_TOKEN = "user_2pAuhYWvKRyhQMnrw6Lfb0evJaG";
...
const testChat = async () => {
    try {
        ...
        const chat1Response1 = await axiosInstance.get(
        ...
        const chat1Response2 = await axiosInstance.get(
        ...
        const chat2Response = await axiosInstance.get(
